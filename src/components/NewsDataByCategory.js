...
const NewsDataByCategory = () => {
  ...
  const CategoryName = useSelector((store) => store?.NewsDataSlice?.category);
  return NewsCategoryData!==null ? (
    <>
...
export default NewsDataByCategory;
